...
const UpdatePlayer = ({ id, onClose }) => {
  ...
  console.log('playerUpdate', modifiedFields);
  ...
  const handleChangeSelectPosition = (event) => {
    ...
    setModifiedFields({ ...modifiedFields, position: selectedPosition });
  };
  ...
  const handleChangeSelectTeam = (event) => {
    ...
    setModifiedFields({ ...modifiedFields, teamId: selectedTeamId });
  };
